...
\section{Comandos Internos}

Estes são utilizados para criar na capa e retornam os valores definidos pelo utilizador nos comandos originais. Estes são apenas utilizados internamente pela classe, mas podem ser utilizados pelo utilizador ao longo do documento para colocar o seu valor algures no texto.
