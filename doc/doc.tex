...
\begin{description}
	...
	\item [\texttt{\textbackslash{}setsupervisor\{}\textit{<orientador(es)>}\texttt{\}}] Define o(s) orientador(es). Para definir mais que um orientador, consulte o comando para definir autores.
	\item [\texttt{\textbackslash{}setcsupervisor\{}\textit{<orientador(es)>}\texttt{\}}] Igual ao comando anterior, mas define o(s) orientador(es) vogais. Permite distinguir os dois grupos caso estes sejam diferentes.
